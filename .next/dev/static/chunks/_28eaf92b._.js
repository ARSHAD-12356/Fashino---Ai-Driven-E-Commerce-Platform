...
"[project]/app/men/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MenPage() {
    ...
    const [season, setSeason] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const subcategories = [
        'T-Shirts',
        'Shirts',
        'Pants',
    ...
    const filteredAndSortedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MenPage.useMemo[filteredAndSortedProducts]": ()=>{
            let filtered = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].filter({
                "MenPage.useMemo[filteredAndSortedProducts].filtered": (p)=>p.category === 'Men'
            }["MenPage.useMemo[filteredAndSortedProducts].filtered"]);
            if (selectedSubcategory) {
                filtered = filtered.filter({
                    "MenPage.useMemo[filteredAndSortedProducts]": (p)=>p.subcategory === selectedSubcategory
                }["MenPage.useMemo[filteredAndSortedProducts]"]);
            }
            if (season) {
                filtered = filtered.filter({
                    "MenPage.useMemo[filteredAndSortedProducts]": (p)=>p.season === season || p.season === 'All-Season'
                }["MenPage.useMemo[filteredAndSortedProducts]"]);
            }
            switch(sortBy){
                case 'price-low':
                    filtered.sort({
                        "MenPage.useMemo[filteredAndSortedProducts]": (a, b)=>a.price - b.price
                    }["MenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                case 'price-high':
                    filtered.sort({
                        "MenPage.useMemo[filteredAndSortedProducts]": (a, b)=>b.price - a.price
                    }["MenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                case 'rating':
                    filtered.sort({
                        "MenPage.useMemo[filteredAndSortedProducts]": (a, b)=>b.rating - a.rating
                    }["MenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                case 'newest':
                    filtered.sort({
                        "MenPage.useMemo[filteredAndSortedProducts]": (a, b)=>b.id - a.id
                    }["MenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                default:
                    break;
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    subcategories.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(MenPage, "YWdtqgcK4H0V2ZtslUUGWuZvYdo=");
_c = MenPage;
var _c;
...
//# sourceMappingURL=_28eaf92b._.js.map
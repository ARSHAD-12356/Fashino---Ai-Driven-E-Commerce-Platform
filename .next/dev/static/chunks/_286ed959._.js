...
function DealsPage() {
    ...
    const [sortBy, setSortBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('discount');
    const hotDeals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DealsPage.useMemo[hotDeals]": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].map({
                "DealsPage.useMemo[hotDeals]": (product)=>({
                        ...product,
                        discountValue: computeDiscount(product.price, product.originalPrice)
                    })
            }["DealsPage.useMemo[hotDeals]"]).filter({
                "DealsPage.useMemo[hotDeals]": (product)=>product.discountValue >= 25
            }["DealsPage.useMemo[hotDeals]"]);
        }
    }["DealsPage.useMemo[hotDeals]"], [
    ...
    const visibleProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DealsPage.useMemo[visibleProducts]": ()=>{
            let filtered = hotDeals;
            if (selectedCategory) {
                filtered = filtered.filter({
                    "DealsPage.useMemo[visibleProducts]": (product)=>product.category === selectedCategory
                }["DealsPage.useMemo[visibleProducts]"]);
            }
            switch(sortBy){
                case 'price-low':
                    filtered = [
                        ...
                        "DealsPage.useMemo[visibleProducts]": (a, b)=>a.price - b.price
                    }["DealsPage.useMemo[visibleProducts]"]);
                    break;
                case 'price-high':
                    filtered = [
                        ...
                        "DealsPage.useMemo[visibleProducts]": (a, b)=>b.price - a.price
                    }["DealsPage.useMemo[visibleProducts]"]);
                    break;
                case 'rating':
                    filtered = [
                        ...
                        "DealsPage.useMemo[visibleProducts]": (a, b)=>b.rating - a.rating
                    }["DealsPage.useMemo[visibleProducts]"]);
                    break;
                case 'newest':
                    filtered = [
                        ...
                        "DealsPage.useMemo[visibleProducts]": (a, b)=>b.id - a.id
                    }["DealsPage.useMemo[visibleProducts]"]);
                    break;
                case 'discount':
                default:
                    filtered = [
                        ...
                        "DealsPage.useMemo[visibleProducts]": (a, b)=>b.discountValue - a.discountValue
                    }["DealsPage.useMemo[visibleProducts]"]);
            }
            return filtered;
        }
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: dealCategories.map((filter)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(DealsPage, "eAF4mIm3MOiXZTor2PRiyWxZ8mg=");
_c = DealsPage;
var _c;
...
//# sourceMappingURL=_286ed959._.js.map
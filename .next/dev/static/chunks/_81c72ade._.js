...
_s(Header, "/7UoInXGYJp5KjTA/NjuTfOwQEw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$cart$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"],
...
function WomenPage() {
    ...
    const filteredAndSortedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WomenPage.useMemo[filteredAndSortedProducts]": ()=>{
            let filtered = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$products$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["products"].filter({
                "WomenPage.useMemo[filteredAndSortedProducts].filtered": (p)=>p.category === 'Women'
            }["WomenPage.useMemo[filteredAndSortedProducts].filtered"]);
            if (selectedSubcategory) {
                filtered = filtered.filter({
                    "WomenPage.useMemo[filteredAndSortedProducts]": (p)=>p.subcategory === selectedSubcategory
                }["WomenPage.useMemo[filteredAndSortedProducts]"]);
            }
            if (season) {
                filtered = filtered.filter({
                    "WomenPage.useMemo[filteredAndSortedProducts]": (p)=>p.season === season || p.season === 'All-Season'
                }["WomenPage.useMemo[filteredAndSortedProducts]"]);
            }
            switch(sortBy){
                case 'price-low':
                    filtered.sort({
                        "WomenPage.useMemo[filteredAndSortedProducts]": (a, b)=>a.price - b.price
                    }["WomenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                case 'price-high':
                    filtered.sort({
                        "WomenPage.useMemo[filteredAndSortedProducts]": (a, b)=>b.price - a.price
                    }["WomenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                case 'rating':
                    filtered.sort({
                        "WomenPage.useMemo[filteredAndSortedProducts]": (a, b)=>b.rating - a.rating
                    }["WomenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                case 'newest':
                    filtered.sort({
                        "WomenPage.useMemo[filteredAndSortedProducts]": (a, b)=>b.id - a.id
                    }["WomenPage.useMemo[filteredAndSortedProducts]"]);
                    break;
                default:
                    break;
...
_s(WomenPage, "YWdtqgcK4H0V2ZtslUUGWuZvYdo=");
_c = WomenPage;
var _c;
...
//# sourceMappingURL=_81c72ade._.js.map